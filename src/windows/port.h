...
extern int GOOGLELOG_EXPORT snprintf(char* str, size_t size, const char* format,
                                ...);
#endif
extern int GOOGLELOG_EXPORT safe_vsnprintf(char* str, size_t size,
...
extern GOOGLELOG_EXPORT struct tm* localtime_r(const time_t* timep,
                                          struct tm* result);
#endif // not HAVE_LOCALTIME_R

#ifndef HAVE_GMTIME_R
extern GOOGLELOG_EXPORT struct tm* gmtime_r(const time_t* timep, struct tm* result);
